...
@allure.story(AllureStory.X_FAILED)
@allure.sub_suite(AllureStory.X_FAILED)
class TestXFailedFunction:
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения в теле самого теста (XFAIL)')
    def test_xfailed_call_body(self, courses_page_with_courses: CoursesPage):
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом function (XFAIL)')
    @pytest.mark.usefixtures('failed_fixture_setup')
    def test_xfailed_setup_function(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения teardown фикстуры со скоупом function (XFAIL)')
    @pytest.mark.usefixtures('failed_fixture_teardown')
    def test_xfailed_teardown_function(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup и teardown фикстур со скоупом function (XFAIL)')
    @pytest.mark.usefixtures('failed_fixture_setup')
    @pytest.mark.usefixtures('failed_fixture_teardown')
    def test_xfailed_setup_and_teardown_function(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения в теле теста и teardown фикстуры со скоупом function (XFAIL)')
    @pytest.mark.usefixtures('failed_fixture_teardown')
    def test_xfailed_call_body_and_teardown_function(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
...
@allure.story(AllureStory.X_FAILED)
@allure.sub_suite(AllureStory.X_FAILED)
class TestXFailedSetupSession:
    @pytest.mark.failed_session
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом session (XFAIL)')
    def test_xfailed_setup_session(self, courses_page_failed: CoursesPage):
...
class TestXFailedSetupClass:
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом class (1) (XFAIL)')
    def test_xfailed_setup_class_1(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом class (2) (XFAIL)')
    def test_xfailed_setup_class_2(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом class (3) (XFAIL)')
    def test_xfailed_setup_class_3(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
...
class TestXFailedSetupModule:
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка падения setup фикстуры со скоупом module (1)')
    def test_xfailed_setup_module_1(self, courses_page_from_module: CoursesPage):
    ...
    def test_xfailed_setup_module_2(self, courses_page_from_module: CoursesPage):
        courses_page_from_module.visit(url=AppRoute.COURSES)
    ...
    def test_xfailed_setup_module_3(self, courses_page_from_module: CoursesPage):
        courses_page_from_module.visit(url=AppRoute.COURSES)
...
@allure.story(AllureStory.X_FAILED)
@allure.sub_suite(AllureStory.X_FAILED)
class TestXPassFunction:
    @allure.severity(Severity.NORMAL)
    @allure.title('Проверка исправленного бага (1)')
    def test_xpass_1(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    def test_xpass_2(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)
    ...
    def test_xpass_3(self, courses_page_with_courses: CoursesPage):
        courses_page_with_courses.visit(url=AppRoute.COURSES)

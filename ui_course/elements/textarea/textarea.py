...
class Textarea(LocatorInit):
    """
    Класс для действий и проверок элемента textarea.
    """

    def __init__(self, page: Page, locator: str, name: str = None, child_locator: str = '//textarea', step: str = ''):
        super().__init__(page, locator, name, child_locator, step)

        self.type_of: str = 'textarea'
